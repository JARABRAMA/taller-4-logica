...
def draw_neural_net(ax, left, right, bottom, top, layer_sizes):
    ...
    :parameters:
        ...
        - left : float
            The center of the leftmost root(s) will be placed here
        - right : float
            The center of the rightmost root(s) will be placed here
        - bottom : float
            The center of the bottommost root(s) will be placed here
        - top : float
            The center of the topmost root(s) will be placed here
...
def get_activations(model, model_inputs, layer_name=None):
    ...
    # we remove the placeholders (Inputs root in Keras). Not the most elegant though..
